...
function index()
    ...
    entry({"api", "misystem", "vas_info"},              call("getVasInfo"), (""), 157)
    entry({"api", "misystem", "vas_switch"},            call("setVasInfo"), (""), 158)
    -- parentalctl
...
function getDeviceInfo()
    ...
    info["invalid_page_status"] = vasinfo.invalid_page_status
    info["security_page_status"]= vasinfo.security_page_status
    info["gouwudang_status"]    = vasinfo.gouwudang_status
