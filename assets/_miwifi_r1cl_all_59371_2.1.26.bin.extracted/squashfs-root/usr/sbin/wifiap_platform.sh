...
wifiap_scan_process()
{
    ...
    local security=`echo $item | awk '{print $4}'`
...
EOF
    ...
    wifiap_bridge_client_set_r1cl ||  { wifiap_fail_process; return 1; }

    wifiap_macfilter_disable_r1cl ||  { wifiap_fail_process; return 1; }
